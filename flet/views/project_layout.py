...
from components.boards import Board
from services.data_store import DataStore
from components.sidebar import Sidebar
from components import *

class ProjectLayout(Row):
    def __init__(self, page: Page, store: DataStore, *args, **kwargs):
                ...
                Row(
                    [
                        TextField(
                            ...
                            focused_border_color=colors.BLACK45,
                            suffix_icon=icons.SEARCH,
                            bgcolor=colors.GREY_900,
                        )
                    ]
                ),
                Row([Text(value="No Boards to Display")]),
            ],
            expand=True,
        )
