...
class Sidebar(UserControl):
    ...
    def __init__(self, app_layout, store: DataStore, page):
        super().__init__()
        # No project models currently in db
        ...
        self.top_nav_items = [
            NavigationRailDestination(
                label_content=Text("Project Boards"),
                label="Projects",
                icon=icons.BOOK_OUTLINED,
                selected_icon=icons.BOOK_OUTLINED
            ),
            NavigationRailDestination(
                label_content=Text("Crews"),
                label="Crews",
                icon=icons.MEMORY_OUTLINED,
                selected_icon=icons.MEMORY_OUTLINED
            ),
        ]
